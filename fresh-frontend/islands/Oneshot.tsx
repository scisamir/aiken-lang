...
import { Validators, AppliedValidators, applyParams } from "~/utils.ts";
...
export default function Oneshot({ validators }: OneshotProps) {
    ...
    return (
        <div>
            {!lucid ? (
                <form class="mt-g10 grid grid-cols-1 gap-y-8" onSubmit={setupLucid}>
                    <Input 
                        type="password"
                        id="blockfrostAPIkey"
                        ...
                        {lockTxHash && (
                            <>
                                ...
                                <Button
                                    ...
                                    disabled={waitingUnlockTx || !!unlockTxHash}
                                >
                                    {waitingUnlockTx
                                        ? "Waiting for Tx..."
